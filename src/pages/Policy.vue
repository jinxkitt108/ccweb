<template>
<q-page padding>
  <q-card flat class="q-mx-auto" style="max-width: 900px">
    <q-card-section>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to CCWeb.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CCWeb, accessible from
            <a
              href="https://ccweb-cc466.firebaseapp.com/"
              rel="external nofollow noopener"
              target="_blank"
              >https://ccweb-cc466.firebaseapp.com/</a
            >
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: ccwebgroup@gmail.com</li>
      </ul>
    </q-card-section>
  </q-card>
</q-page>
